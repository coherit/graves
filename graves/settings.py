"""
Django settings for graves project.
"""
...
DATATYPE_LOCATIONS.append("graves.datatypes")
FUNCTION_LOCATIONS.append("graves.functions")
ETL_MODULE_LOCATIONS.append("graves.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("graves.search_components")
...
SECRET_KEY = "django-insecure-9t3$r-g@c-rkutsj_t#qz*@u5lbmz&yt9usxn)j9#uvt0onxj7"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "graves.urls"
ROOT_HOSTCONF = "graves.hosts"
...
WSGI_APPLICATION = "graves.wsgi.application"
...
# ES_MAPPING_MODIFIER_CLASSES = ["graves.search.es_mapping_modifier.EsMappingModifier"]
